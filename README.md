...
**+2 ans d'expérience en ESN et startup** | Spécialisé en architectures modernes (microservices, REST API) et méthodologies Agiles (Scrum, Kanban) | 13 ans d'expérience en management d'équipe transférables au développement logiciel

🟢 **Disponible immédiatement** pour un poste en **CDI**  
📍 **Île-de-France** | [📧 tarnof@hotmail.com](mailto:tarnof@hotmail.com) | [🔗 LinkedIn](https://www.linkedin.com/in/nicolas-tatarinoff-developpeur-fullstack-java-spring-react-vue-javascript/)
...
Issue de **13 ans d'expérience en management** (Directeur d'accueils collectifs de mineurs), j'apporte des compétences précieuses au développement logiciel :

- 👥 **Leadership & Management** : Direction d'équipes jusqu'à 30 collaborateurs
